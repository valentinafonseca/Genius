...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">QUAL É O DESENHO QUE COMEÇA COM A VOGAL A ?</H1>
    ...
    <!-- audios -->
    <audio id="click-sound" src="at1.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('ara')" src="../../animais/ara.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('err')" src="../../animais/ele.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('err')" src="../../animais/ove.png" alt="Option 1" class="aranha" id="bee2">
    ...
    // Criar um novo elemento de imagem
            ...
            function botao(x) {
                ...
                var un3 = localStorage.setItem('uni3', 0);
 ...
 if (err<2) {
            if (y=="ara"){
                ...
                localStorage.setItem('uni2', un2);
                localStorage.setItem('uni3', un3);
