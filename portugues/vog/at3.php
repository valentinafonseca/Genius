...
<br><br><br>
                    <div id="cor">
                       <br>
                <H1 style="margin-left:18%;color: white;">QUAL É O DESENHO QUE COMEÇA COM A VOGAL I ?</H1> 
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <img onclick="botao('err')" src="../../animais/ove.png" alt="Option 2" class="aranha" id="uva">
                        <img onclick="botao('ok')" src="../../animais/iguana.png" alt="Option 3" class="aranha" id="ja">
    ...
    // Criar um novo elemento de imagem
            ...
            function botao(x) {
                var u4= localStorage.getItem('uni4');
                var un5 = localStorage.setItem('uni5',0);
                var y=x;
   ...
   if (err<2) {
            if (y=="ok"){
                ...
                un4=2;
                un5=1;
                localStorage.setItem('uni4', un4);
                localStorage.setItem('uni5', un5);
