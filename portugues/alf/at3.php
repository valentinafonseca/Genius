...
<br><br><br>
                    <div id="cor">
                       <br>
                <H1 style="margin-left:18%;color: white;">QUAL É O DESENHO QUE COMEÇA COM A LETRA K ?</H1> 
    ...
    <!-- audios -->
    <audio id="click-sound" src="../../portugues/audio/at3.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                <img onclick="botao('nav')" src="../../imagens/nav.png" alt="Option 2" class="aranha" id="uva">
                        <img onclick="botao('pato')" src="../../animais/tartaruga.png" alt="Option 3" class="aranha" id="ja">
                        <img onclick="botao('kik')" src="../../imagens/kiko.png" alt="Option 1" class="aranha" id="lua">
    ...
    // Criar um novo elemento de imagem
            ...
            function botao(x) {
                var status = localStorage.getItem('btn1');
                var y=x;
