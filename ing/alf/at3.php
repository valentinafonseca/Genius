...
<br><br><br>
    ...
    <!-- audios -->
    <audio id="click-sound" src="at3.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('ok')" src="m.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('err')" src="n.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('err')" src="p.png" alt="Option 1" class="aranha" id="bee2">
    ...
    // Criar um novo elemento de imagem
            ...
            function botao(x) {
                ...
                var i2 = localStorage.getItem('i2',0);
