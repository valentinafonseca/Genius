...
<br><br><br>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('err')" src="../../imagens/2.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('err')" src="../../imagens/0.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('ok')" src="../../imagens/1.png" alt="Option 1" class="aranha" id="bee2">
