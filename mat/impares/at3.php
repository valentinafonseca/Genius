...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">QUAL DOS SEGUINTES NÚMEROS É ÍMPAR ?</H1>
    ...
    <!-- audios -->
    <audio id="click-sound" src="impar.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('err')" src="8.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('err')" src="6.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('ok')" src="3.png" alt="Option 1" class="aranha" id="bee2">
    ...
    // Criar um novo elemento de imagem
            ...
            function botao(x) {
                ...
                var at1 = localStorage.getItem('m3');
                var at2 = localStorage.setItem('m4', 0);
                var y=x;
 ...
 if (err<2) {
            if (y=="ok"){
                ...
                localStorage.setItem('m3', at1);
                localStorage.setItem('m4', at2);
