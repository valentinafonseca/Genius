...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">QUAL É O DESENHO QUE COMEÇA COM A LETRA B ?</H1>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('certo')" src="../../animais/bola.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('casa')" src="../../animais/casa.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('abe')" src="../../animais/bee.png" alt="Option 1" class="aranha" id="bee2">
