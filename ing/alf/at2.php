...
<br><br><br>
    ...
    <!-- audios -->
    <audio id="click-sound" src="g.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('err')" src="h.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('err')" src="z.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('ok')" src="g.png" alt="Option 1" class="aranha" id="bee2">
