...
<br><br><br>
                    <div id="cor">
                       <br>
                <H1 style="margin-left:18%;color: white;">QUAL É O DESENHO QUE COMEÇA COM A VOGAL U?</H1> 
    ...
    <!-- audios -->
    <audio id="click-sound" src="at2.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                <img onclick="botao('err')" src="../../animais/iguana.png" alt="Option 2" class="aranha" id="uva">
                        <img onclick="botao('err')" src="../../animais/ove.png" alt="Option 3" class="aranha" id="ja">
                        <img onclick="botao('certo')" src="../../animais/beer.png" alt="Option 1" class="aranha" id="lua">
    ...
    // Criar um novo elemento de imagem
            ...
            function botao(x) {
                var uni4 = localStorage.setItem('uni4',0);
                var uni3 = localStorage.getItem('uni3');
                var y=x;
   ...
   if (err<2) {
            if (y=="certo"){
                ...
                uni3=2;
                uni4=1;
                localStorage.setItem('uni3', uni3);
                localStorage.setItem('uni4', uni4);
