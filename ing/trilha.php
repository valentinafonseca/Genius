...
<nav class="materia">
        <ul class="menu-materia">
            ...
            <li><a href="../ing/trilh.php">Inglês</a></li>
            <li><a href="../portugues/trilha_portugues.php">Português</a></li>
        </ul>
    </nav>

<p style="text-align: center; margin-top: 3%;">Olá seja bem-vindo "nome"</p> <br>
<!-- corpo atividades -->
<div id="corpo">
  <table id="corpo_at">
    <tr>
...
<tr><td></td><TD></TD><td class="nome">LIKE & DISLIKE</td></tr>
...
<tr><td></td><TD> </TD><td class="nome">NUMBERS</td></tr>
<td>
  <div class="at" id="imgdiv7" onclick="ativ('7')"></div>
</td>
</tr>
<tr>
<td class="nome">FORMAS</td></tr>
<tr><td></td><td></td>
  <td>
    <div class="at" id="imgdiv8" onclick="ativ('8')"></div>
  </td>
</tr>
<tr><td></td><td></td><td class="nome">PRESENTAÇÃO</td></tr>
</table>
<img src="ara.png" id="porco">
<img src="ara.png" id="coala">
</div>
<script>
      var un1=localStorage.getItem('i');
      var un2=localStorage.getItem('i2');
      var un3=localStorage.getItem('i3');
      var un4=localStorage.getItem('i4');
      var un5=localStorage.getItem('i5');
      var un6=localStorage.getItem('i6');
      var un7=localStorage.getItem('i7');
      var un8=localStorage.getItem('i8');
    const imageUrl1 = 'ok.png'; 
    const ok1 = 'ok.png'; 
    const imageUrl2 = 'fec.png'; 
 ...
 if (un1<=1) {
  img.src = imageUrl2; // Define a fonte da imagem
    ...
    function ativ(at) {
      ...
      if  (x==2 && un1==2) {
        window.location.replace('anim/animais.php');
      }
      else if(x==3 && un2==2) {
