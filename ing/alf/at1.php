...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">QUAL É A LETRA QUE TEM O SOM __</H1>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('ok')" src="B.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('err')" src="Y.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('err')" src="E.png" alt="Option 1" class="aranha" id="bee2">
    ...
    // Criar um novo elemento de imagem
            ...
            function botao(x) {
                ...
                var at1 = localStorage.setItem('i', 0);
                var y=x;
