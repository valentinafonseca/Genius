...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">QUAL O RESULTADO DA SUBTRAÇÃO 10-2 ?</H1>
    ...
    <!-- audios -->
    <audio id="click-sound" src="10-2.mp3" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('ok')" src="../../imagens/8.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('err')" src="../../imagens/5.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('err')" src="../../imagens/6.png" alt="Option 1" class="aranha" id="bee2">
