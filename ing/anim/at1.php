<DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../../ing/at1.css">
...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">QUAL A IMAGEM DA PALAVRA "COW" ?</H1>
    ...
    <!-- audios -->
    <audio id="click-sound" src="at1.mp3" preload="auto"></audio>
    <!-- Inclua a biblioteca de ícones Font Awesome se necessário -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">

 
                <br>
                        <img onclick="botao('err')" src="CACHORRO.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('ok')" src="VACA.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('err')" src="leão.png" alt="Option 1" class="aranha" id="bee2">
    ...
    // Criar um novo elemento de imagem
            ...
            function botao(x) {
                ...
                var at1 = localStorage.setItem('i2', 0);
                var y=x;
