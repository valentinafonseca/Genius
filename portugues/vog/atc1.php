...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">QUAL É O DESENHO QUE COMEÇA COM A CONSOANTE F ?</H1>
    ...
    <!-- audios -->
    <audio id="click-sound" src="f.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('err')" src="../../imagens/kart.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('ok')" src="../../animais/foca.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('err')" src="../../animais/hippo.png" alt="Option 1" class="aranha" id="bee2">
                    
            </div>
            
           
           
           <a href="atc2.php"><div id="imgdiv" style="margin-left:90%;"></div></a>
