...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">QUAL DAS IMAGENS REPRESENTA O NÚMERO ORDINAL "PRIMEIRO" ?</H1>
    ...
    <!-- audios -->
    <audio id="click-sound" src="PRIMEIRO.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('ok')" src="primeiro.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('err')" src="segundo.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('err')" src="terceiro.png" alt="Option 1" class="aranha" id="bee2">
