...
<br><br><br>
    ...
    <!-- audios -->
    <audio id="click-sound" src="bi.mp3" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('err')" src="../../imagens/bo.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('err')" src="../../imagens/be.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('ok')" src="../../imagens/bi.png" alt="Option 1" class="aranha" id="bee2">
                    
            </div>
            
           
           
           <a href="atf3.php"><div id="imgdiv" style="margin-left:90%;"></div></a>
