...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">CLICK NO SOM</H1>
    ...
    <!-- audios -->
    <audio id="click-sound" src="coruja.mp3" preload="auto"></audio>
 ...
 <div>
                <br>
                        <img onclick="botao('ara')" src="../../imagens/cine.png">
                        <img onclick="botao('ok')" src="../../imagens/cor.png" style="margin-left:15%;">
                        <img onclick="botao('err')" src="../../imagens/cane.png" style="margin-left:30%;">
    ...
    // Criar um novo elemento de imagem
            function botao(x) {
                ...
                var un2 = localStorage.getItem('uni8');
                var y=x;
