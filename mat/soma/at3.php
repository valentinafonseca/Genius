...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">QUAL O RESULTADO DA SOMA 4+4?</H1>
    ...
    <!-- audios -->
    <audio id="click-sound" src="4+4.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('ok')" src="../pares/8.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('err')" src="../pares/6.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('ok')" src="../pares/3.png" alt="Option 1" class="aranha" id="bee2">
    ...
    // Criar um novo elemento de imagem
            ...
            function botao(x) {
                ...
                var at1 = localStorage.getItem('m5');
                var at2 = localStorage.setItem('m6', 0);
                var y=x;
 ...
 if (err<2) {
            if (y=="ok"){
                ...
                localStorage.setItem('m5', at1);
                localStorage.setItem('m6', at2);
