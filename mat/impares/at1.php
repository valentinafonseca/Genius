...
<br><br><br>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('err')" src="../../imagens/4.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('err')" src="../../imagens/10.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('ok')" src="5.png" alt="Option 1" class="aranha" id="bee2">
    ...
    // Criar um novo elemento de imagem
            ...
            function botao(x) {
                ...
                var at1 = localStorage.setItem('m3', 0);
                var y=x;
