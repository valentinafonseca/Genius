...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">EM QUAL DAS IMAGENS O COELHO ESTÁ EM TERCEIRO LUGAR?</H1>
    ...
    <!-- audios -->
    <audio id="click-sound" src="terceiro.wav" preload="auto"></audio>
    <!-- Inclua a biblioteca de ícones Font Awesome se necessário -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">

 
                <br>
                        <img onclick="botao('err')" src="1°.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('err')" src="2°.png" alt="Option 3" class="aranha" id="casa1">
