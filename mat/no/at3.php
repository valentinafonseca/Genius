<DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../../styles/at1mat.css">
...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">QUAL IMAGEM TEM EM ORDEM OS NÚMEROS "QUARTO, QUINTO E SEXTO" ?</H1>
    ...
    <!-- audios -->
    <audio id="click-sound" src="456.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('err')" src="123.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('ok')" src="456.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('err')" src="789.png" alt="Option 1" class="aranha" id="bee2">
                    
            </div>
            
           
           
           <a href="../trilha.php"><div id="imgdiv" style="margin-left:90%;"></div></a>
   
           <script>
     const imageUrl = '../l.png'; 
    // Criar um novo elemento de imagem
   
            function botao(x) {
                
                var at1 = localStorage.getItem('m4');
                var at2 = localStorage.setItem('m5', 0);
                var y=x;
 ...
 if (err<2) {
            if (y=="ok"){
                ...
                localStorage.setItem('m4', at1);
                localStorage.setItem('m5', at2);
