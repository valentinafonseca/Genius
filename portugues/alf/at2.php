...
<br><br><br>
                    <div id="cor">
                       <br>
                <H1 style="text-align: center;color: white;">QUAL É O DESENHO QUE COMEÇA COM A LETRA J ?</H1> 
    ...
    <!-- audios -->
    <audio id="click-sound" src="../../portugues/audio/at2.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                <img onclick="botao('uva')" src="../../imagens/uva.png" alt="Option 2" class="aranha" id="uva">
                        <img onclick="botao('ja')" src="../../imagens/janela.png" alt="Option 3" class="aranha" id="ja">
                        <img onclick="botao('lua')" src="../../imagens/lua.png" alt="Option 1" class="aranha" id="lua">
