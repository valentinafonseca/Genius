...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">QUAL É O DESENHO QUE COMEÇA COM A CONSOANTE Q ?</H1>
    ...
    <!-- audios -->
    <audio id="click-sound" src="q.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('err')" src="../../imagens/xicara.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('ok')" src="../../imagens/queijo.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('err')" src="../../animais/sapo.png" alt="Option 1" class="aranha" id="bee2">
                    
            </div>
            
           
           
           <a href="../trilha_portugues.php"><div id="imgdiv" style="margin-left:90%;"></div></a>
    ...
    // Criar um novo elemento de imagem
            ...
            function botao(x) {
                ...
                var un3 = localStorage.setItem('uni8', 0);
                var un2 = localStorage.getItem('uni7');
                var y=x;
 ...
 if (err<2) {
            if (y=="ok"){
                ...
                localStorage.setItem('uni7', un2);
                localStorage.setItem('uni8', un3);
