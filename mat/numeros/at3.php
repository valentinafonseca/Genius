...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">CLIQUE NO SOM</H1>
    ...
    <!-- audios -->
    <audio id="click-sound" src="../9.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        <img onclick="botao('err')" src="../../imagens/0.png" alt="Option 2" class="aranha" id="bola1">
                        <img onclick="botao('err')" src="../../imagens/6.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('ok')" src="../../imagens/9.png" alt="Option 1" class="aranha" id="bee2">
    ...
    // Criar um novo elemento de imagem
            ...
            function botao(x) {
                ...
                var at1 = localStorage.setItem('m1', 0);
                var at2 = localStorage.setItem('m2', 0);
                var y=x;
 ...
 if (err<2) {
            if (y=="ok"){
                ...
                localStorage.setItem('m1', at1);
                localStorage.setItem('m2', at2);
