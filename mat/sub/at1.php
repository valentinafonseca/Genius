...
<br><br><br>
                    <div id="cor">
                       <br>
               <H1 style="margin-left:18%; color: white;">QUAL O RESULTADO DA SUBTRAÇÃO 5-2?</H1>
    ...
    <!-- audios -->
    <audio id="click-sound" src="5-2.wav" preload="auto"></audio>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
                ...
                <br>
                        ...
                        <img onclick="botao('err')" src="../../imagens/2.png" alt="Option 3" class="aranha" id="casa1">
                        <img onclick="botao('ok')" src="../../imagens/3.png" alt="Option 1" class="aranha" id="bee2">
                    
            </div>
            
           
           
           <a href="at2.php"><div id="imgdiv" style="margin-left:90%;"></div></a>
